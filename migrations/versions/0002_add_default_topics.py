...
def downgrade() -> None:
    ...
    op.execute(
        "DELETE FROM topics WHERE slug IN ('python', 'javascript', 'devops', 'machine-learning', 'web-development', 'mobile-development', 'database', 'security', 'cloud-computing', 'blockchain')"
    )
